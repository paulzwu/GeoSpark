 ...
 * @version 1.0
 *
 * This is an implementation of the algorithm described by Adriano Moreira and
 * Maribel Yasmina Santos: CONCAVE HULL: A K-NEAREST NEIGHBOURS APPROACH FOR THE
 * COMPUTATION OF THE REGION OCCUPIED BY A SET OF POINTS. GRAPP 2007 -
 * International Conference on Computer Graphics Theory and Applications; pp
 * 61-68.
 *
...
public class KNNConcaveHull {
     ...
     * @param k Integer for K-nearest neighbor 
     * @return
     */
    public Geometry getKnerConcaveHull(Geometry geometry, Integer k)  {
...
// Simply pass an array of Coordinate or a CoordinateSequence to its method
     ...
     ArrayList<Point> calculateConcaveHull(ArrayList<Point> pointArrayList, Integer k) {
        ...
        while ((currentPoint != firstPoint || step == 2) && pointArraySet.size() > 0) {
            ...
            if (its) {
            	...
            	//al.add(geometryFactory.createPoint(new Coordinate(0., 0.)));
            	//al.add(geometryFactory.createPoint(new Coordinate(0., 0.)));
            	return al;
            }
    ...
    public static void main(String args[]) {
        //Point p[] = new Point[5];
        GeometryFactory gf = JTSFactoryFinder
                .getGeometryFactory();
