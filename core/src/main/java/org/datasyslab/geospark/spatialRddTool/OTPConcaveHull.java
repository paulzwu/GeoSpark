...
public class OTPConcaveHull  {
	 ...
	 * @param threshold
	 */
	public OTPConcaveHull(Geometry geometry, double threshold) {
	 ...
	 * @param threshold
	 */
	public OTPConcaveHull(GeometryCollection geometries, double threshold) {
